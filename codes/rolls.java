...
public class rolls extends JFrame implements ActionListener
{
    JPanel p1;
    ...
    private int price2=130;
    private int price3=155;
    private int price4=80;
    ...
    rolls()
    {
        ...
        //-------------------------------------------------
        l2=new JLabel("<html>1.Chicken Shawarma<br>rs/- =120</html>");
        ...
        p1.add(minus1);
        //----------------------------------------------------------------
        l3=new JLabel("<html>2.Egg Roll<br>rs/- =130</html>");
        ...
        l3=new JLabel("<html>3.Paneer Roll<br>rs/- =155</html>");
        ...
        l4=new JLabel("<html>4.Veg Roll<br>rs/- =80</html>");
   ...
   p4.add(e8);
    ...
    public void actionPerformed(ActionEvent e)
    {
       ...
       if(e.getSource()==plus1)
       {
        ...
        item1.setText("<html>1.Chicken Shawarma <U> QUANTITY ="+quantity1+" PRICE ="+(sum1));
        ...
        if(e.getSource()==plus2)
        {
            ...
            item2.setText("<html>2.Egg roll<u> QUANTITY ="+quantity2+" PRICE ="+sum2);
        ...
        if(e.getSource()==plus3)
        {
            ...
            item3.setText("<html>3.Paneer Roll<u> QUANTITY ="+quantity3+" PRICE ="+sum3);
        ...
        if(e.getSource()==plus4)
        {
            ...
            item4.setText("<html>4.Veg Roll<u> QUANTITY ="+quantity4+" PRICE ="+sum4);
        }
