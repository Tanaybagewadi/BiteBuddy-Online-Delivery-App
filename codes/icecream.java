...
public class icecream extends JFrame implements ActionListener
{
    ...
    private int price1 = 220;
    private int price2=145;
    private int price3=168;
    private int price4=296;
    ...
    icecream()
    {
        ...
        //-------------------------------------------------
        l2=new JLabel("<html>1.Classic Death by Chocolate<br>rs/- =220</html>");
        ...
        p1.add(minus1);
        //----------------------------------------------------------------
        l3=new JLabel("<html>2.Hot chococolate fudge<br>rs/- =145</html>");
        ...
        l3=new JLabel("<html>3.Vanilla ICE Cream<br>rs/- =165</html>");
        ...
        l4=new JLabel("<html>4.Belgian Chocolate<br> Ice Creamrs/- =296</html>");
   ...
   p4.add(e8);
    ...
    public void actionPerformed(ActionEvent e)
    {
       ...
       if(e.getSource()==plus1)
       {
        ...
        item1.setText("<html>1.Classic Death by Chocolate<U> QUANTITY ="+quantity1+" PRICE ="+(sum1));
        ...
        if(e.getSource()==plus2)
        {
            ...
            item2.setText("<html>2.Hot chocolate Fudge<u> QUANTITY ="+quantity2+" PRICE ="+sum2);
        ...
        if(e.getSource()==plus3)
        {
            ...
            item3.setText("<html>3.Vanilla ICE Cream<u> QUANTITY ="+quantity3+" PRICE ="+sum3);
        ...
        if(e.getSource()==plus4)
        {
            ...
            item4.setText("<html>4.Belgian Chocolate Ice Cream<u> QUANTITY ="+quantity4+" PRICE ="+sum4);
        }
