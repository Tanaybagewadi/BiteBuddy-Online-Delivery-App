...
public class pizza extends JFrame implements ActionListener
{
   ...
   // String a,b,c,d;
    pizza()
    {
        ...
        //-------------------------------------------------
        l2=new JLabel("<html>1.Capcicum Pizza<br>rs/- =120</html>");
        ...
        p1.add(minus1);
        //----------------------------------------------------------------
        l3=new JLabel("<html>2.Chicken Sausage pizza<br>rs/- =186</html>");
        ...
        l3=new JLabel("<html>3.Veg Pizza<br>rs/- =120</html>");
        ...
        l4=new JLabel("<html>4.Chilli and Panner Pizza<br>rs/- =160</html>");
   ...
   p4.add(e8);
    ...
    public void actionPerformed(ActionEvent e)
    {
       ...
       if(e.getSource()==plus1)
       {
        ...
        item1.setText("<html>1.Capcicum Pizza<U>QUANTITY ="+quantity1+" PRICE ="+(sum1));
        ...
        if(e.getSource()==plus2)
        {
            ...
            item2.setText("<html>2.Chicken Sausage Pizza<u>QUANTITY ="+quantity2+" PRICE ="+sum2);
        ...
        if(e.getSource()==plus3)
        {
            ...
            item3.setText("<html>3.Veg Pizza <u>QUANTITY ="+quantity3+" PRICE ="+sum3);
        ...
        if(e.getSource()==plus4)
        {
            ...
            item4.setText("<html>4.Chilli and Panner Pizza<u> QUANTITY ="+quantity4+" PRICE ="+sum4);
        }
