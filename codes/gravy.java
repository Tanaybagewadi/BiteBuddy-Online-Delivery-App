...
public class gravy extends JFrame implements ActionListener
{
    JPanel p1;
    ...
    private int price1 = 320;
    private int price2=386;
    private int price3=120;
    private int price4=160;
    ...
    gravy()
    {
        ...
        //-------------------------------------------------
        l2=new JLabel("<html>1.Ch manchurian gravy<br>rs/- =320</html>");
        ...
        p1.add(minus1);
        //----------------------------------------------------------------
        l3=new JLabel("<html>2.Hydrabadi gravy<br>rs/- =386</html>");
        ...
        l3=new JLabel("<html>3.Dall tadks<br>rs/- =120</html>");
        ...
        l4=new JLabel("<html>4.Veg panner gravy<br>rs/- =160</html>");
   ...
   p4.add(e8);
    ...
    public void actionPerformed(ActionEvent e)
    {
       ...
       if(e.getSource()==plus1)
       {
        ...
        item1.setText("<html>1.Ch manchurian gravy <U> QUANTITY ="+quantity1+" PRICE ="+(sum1));
        ...
        if(e.getSource()==plus2)
        {
            ...
            item2.setText("<html>2.Hydrabadi gravy <u> QUANTITY ="+quantity2+" PRICE ="+sum2);
        ...
        if(e.getSource()==plus3)
        {
            ...
            item3.setText("<html>3.Dal tadka <u> QUANTITY ="+quantity3+" PRICE ="+sum3);
        ...
        if(e.getSource()==plus4)
        {
            ...
            item4.setText("<html>4.veg panner gravy <u> QUANTITY ="+quantity4+" PRICE ="+sum4);
        }
