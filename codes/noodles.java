...
public class noodles extends JFrame implements ActionListener
{

    JPanel p1;
    JLabel l1,l2,l3,l4,cart,item1,item2,item3,item4,totbl,fbill;
    ...
    private int price1 = 120;
    private int price2=186;
    private int price3=160;
   ...
   // String a,b,c,d;
    noodles()
    {
       ...
       // add(j1);
        ...
        //-------------------------------------------------
        l2=new JLabel("<html>1.Shezwan noodles<br>rs/- =120</html>");
        ...
        p1.add(minus1);
        //----------------------------------------------------------------
        l3=new JLabel("<html>2.Chicken shezwan noodles<br>rs/- =186</html>");
        ...
        l3=new JLabel("<html>3.Egg hakka noodles<br>rs/- =120</html>");
        ...
        l4=new JLabel("<html>4.chicken hakka noodles<br>rs/- =160</html>");
   ...
   p4.add(e8);
    ...
    public void actionPerformed(ActionEvent e)
    {
       ...
       if(e.getSource()==plus1)
       {
        ...
        item1.setText("<html>1.shezwan noodles <U>QUANTITY ="+quantity1+" PRICE ="+(sum1));
        ...
        if(e.getSource()==plus2)
        {
            ...
            item2.setText("<html>2.Chicken shezwan noodles <u>QUANTITY ="+quantity2+" PRICE ="+sum2);
        ...
        {
            quantity3++;
            sum3=calculatebill(quantity3, price1);
            item3.setText("<html>3.egg hakka noodles <u>QUANTITY ="+quantity3+" PRICE ="+sum3);
        ...
        {
            quantity4++;
            sum4=calculatebill(quantity4, price3);
            item4.setText("<html>4.Chicken hakka noodles<u> QUANTITY ="+quantity4+" PRICE ="+sum4);
        }
