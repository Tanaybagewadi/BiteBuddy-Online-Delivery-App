...
public class juice extends JFrame implements ActionListener
{
    JPanel p1;
    ...
    private int price2=60;
    private int price3=80;
    private int price4=60;
    ...
    juice()
    {
        ...
        //-------------------------------------------------
        l2=new JLabel("<html>1.Mosambi Juice<br>rs/- =40</html>");
        ...
        p1.add(minus1);
        //----------------------------------------------------------------
        l3=new JLabel("<html>2.Mixed Fruit Juice<br>rs/- =60</html>");
        ...
        l3=new JLabel("<html>3.Pineapple Juice<br>rs/- =80</html>");
        ...
        l4=new JLabel("<html>4.Promoganate Juice <br>rs/- =60</html>");
   ...
   p4.add(e8);
    ...
    public void actionPerformed(ActionEvent e)
    {
       ...
       if(e.getSource()==plus1)
       {
        ...
        item1.setText("<html>1.Mosambi Juice <U> QUANTITY ="+quantity1+" PRICE ="+(sum1));
        ...
        if(e.getSource()==plus2)
        {
            ...
            item2.setText("<html>2.Mixed Fruit Juice <u> QUANTITY ="+quantity2+" PRICE ="+sum2);
        ...
        if(e.getSource()==plus3)
        {
            ...
            item3.setText("<html>3.Pineapple Juice<u> QUANTITY ="+quantity3+" PRICE ="+sum3);
        ...
        if(e.getSource()==plus4)
        {
            ...
            item4.setText("<html>4.Promoganate Juice<u> QUANTITY ="+quantity4+" PRICE ="+sum4);
        }
