...
public class dosa extends JFrame implements ActionListener
{
    JPanel p1;
    ...
    private int price1 = 60;
    private int price2=70;
    private int price3=80;
    private int price4=85;
    ...
    dosa()
    {
        ...
        //-------------------------------------------------
        l2=new JLabel("<html>1.Plane Dosa<br>rs/- =60</html>");
        ...
        p1.add(minus1);
        //----------------------------------------------------------------
        l3=new JLabel("<html>2.Shezwan Dosa<br>rs/- =70</html>");
        ...
        l3=new JLabel("<html>3.Cheese Dosa<br>rs/- =80</html>");
        ...
        l4=new JLabel("<html>4.Mysore Masala Dosa<br>rs/- =85</html>");
   ...
   p4.add(e8);
    ...
    public void actionPerformed(ActionEvent e)
    {
       ...
       if(e.getSource()==plus1)
       {
        ...
        item1.setText("<html>1.Plane Dosa<U> QUANTITY ="+quantity1+" PRICE ="+(sum1));
        ...
        if(e.getSource()==plus2)
        {
            ...
            item2.setText("<html>2.Shezwan dosa<u> QUANTITY ="+quantity2+" PRICE ="+sum2);
        ...
        if(e.getSource()==plus3)
        {
            ...
            item3.setText("<html>3.Cheese Dosa<u> QUANTITY ="+quantity3+" PRICE ="+sum3);
        ...
        if(e.getSource()==plus4)
        {
            ...
            item4.setText("<html>4.Mysore Masala Dosa<u> QUANTITY ="+quantity4+" PRICE ="+sum4);
        }
