...
public class cake extends JFrame implements ActionListener
{
    ...
    cake()
    {
        ...
        //-------------------------------------------------
        l2=new JLabel("<html>1.Chocklate Cake<br>rs/- =420</html>");
        ...
        p1.add(minus1);
        //----------------------------------------------------------------
        l3=new JLabel("<html>2.Black Forest cake<br>rs/- =386</html>");
        ...
        l3=new JLabel("<html>3.White Forest Cake<br>rs/- =400</html>");
        ...
        l4=new JLabel("<html>4.Death By Chocolate Cake<br>rs/- =460</html>");
   ...
   p4.add(e8);
    ...
    public void actionPerformed(ActionEvent e)
    {
       ...
       if(e.getSource()==plus1)
       {
        ...
        item1.setText("<html>1.Chocklate Cake<U> QUANTITY ="+quantity1+" PRICE ="+(sum1));
        ...
        if(e.getSource()==plus2)
        {
            ...
            item2.setText("<html>2.Black Forest Cake<u> QUANTITY ="+quantity2+" PRICE ="+sum2);
        ...
        if(e.getSource()==plus3)
        {
            ...
            item3.setText("<html>3.White Forest Cake<u> QUANTITY ="+quantity3+" PRICE ="+sum3);
        ...
        if(e.getSource()==plus4)
        {
            ...
            item4.setText("<html>4.Death By Chocolate Cake <u> QUANTITY ="+quantity4+" PRICE ="+sum4);
        }
