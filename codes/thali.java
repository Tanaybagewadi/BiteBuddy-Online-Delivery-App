...
public class thali extends JFrame implements ActionListener
{
    JPanel p1;
    ...
    private int price1 = 420;
    private int price2=586;
    private int price3=320;
    private int price4=660;
    ...
    thali()
    {
        ...
        //-------------------------------------------------
        l2=new JLabel("<html>1.Veg Thali<br>rs/- =420</html>");
        ...
        p1.add(minus1);
        //----------------------------------------------------------------
        l3=new JLabel("<html>2.NON Veg Thali<br>rs/- =586</html>");
        ...
        l3=new JLabel("<html>3.Chinese combo Thali<br>rs/- =320</html>");
        ...
        l4=new JLabel("<html>4.Rajasthani Thali<br>rs/- =460</html>");
   ...
   p4.add(e8);
    ...
    public void actionPerformed(ActionEvent e)
    {
       ...
       if(e.getSource()==plus1)
       {
        ...
        item1.setText("<html>1.Veg Thali <U> QUANTITY ="+quantity1+" PRICE ="+(sum1));
        ...
        if(e.getSource()==plus2)
        {
            ...
            item2.setText("<html>2.NON Veg Thali<u> QUANTITY ="+quantity2+" PRICE ="+sum2);
        ...
        if(e.getSource()==plus3)
        {
            ...
            item3.setText("<html>3.Chinese combo Thali<u> QUANTITY ="+quantity3+" PRICE ="+sum3);
        ...
        if(e.getSource()==plus4)
        {
            ...
            item4.setText("<html>4.Rajsthani Thali <u> QUANTITY ="+quantity4+" PRICE ="+sum4);
        }
