...
public class kichadi extends JFrame implements ActionListener
{
    JPanel p1;
    ...
    private int price1 = 80;
    private int price2=110;
    private int price3=80;
    ...
    kichadi()
    {
        ...
        //-------------------------------------------------
        l2=new JLabel("<html>1.Dal Kichadi<br>rs/- =80</html>");
        ...
        p1.add(minus1);
        //----------------------------------------------------------------
        l3=new JLabel("<html>2.Dal Fry Kichadi<br>rs/- =110</html>");
        ...
        l3=new JLabel("<html>3.Masala Kichadi<br>rs/- =80</html>");
        ...
        l4=new JLabel("<html>4.Panner Kichadi <br>rs/- =160</html>");
   ...
   p4.add(e8);
    ...
    public void actionPerformed(ActionEvent e)
    {
       ...
       if(e.getSource()==plus1)
       {
        ...
        item1.setText("<html>1.Dal Kichadi<U> QUANTITY ="+quantity1+" PRICE ="+(sum1));
        ...
        if(e.getSource()==plus2)
        {
            ...
            item2.setText("<html>2.Dal Fry Kichadi <u> QUANTITY ="+quantity2+" PRICE ="+sum2);
        ...
        if(e.getSource()==plus3)
        {
            ...
            item3.setText("<html>3.Butter Kichadi<u> QUANTITY ="+quantity3+" PRICE ="+sum3);
        ...
        if(e.getSource()==plus4)
        {
            ...
            item4.setText("<html>4.Panner Kichadi<u> QUANTITY ="+quantity4+" PRICE ="+sum4);
        }
