...
public class sandwich extends JFrame implements ActionListener
{
    ...
    private int price2=75;
    private int price3=95;
    ...
    sandwich()
    {
        ...
        //-------------------------------------------------
        l2=new JLabel("<html>1.Club Sandwich<br>rs/- =80</html>");
        ...
        p1.add(minus1);
        //----------------------------------------------------------------
        l3=new JLabel("<html>2.Veg Grilled Sandwich<br>rs/- =35</html>");
        ...
        l3=new JLabel("<html>3.Veg Cheese Sandwich<br>rs/- =95</html>");
        ...
        l4=new JLabel("<html>4.Paneer Makhani Sandwich<br>rs/- =150</html>");
   ...
   p4.add(e8);
    ...
    public void actionPerformed(ActionEvent e)
    {
       ...
       if(e.getSource()==plus1)
       {
        ...
        item1.setText("<html>1.Club Sandwich <U> QUANTITY ="+quantity1+" PRICE ="+(sum1));
        ...
        if(e.getSource()==plus2)
        {
            ...
            item2.setText("<html>2.Veg Grilled Sandwich<u> QUANTITY ="+quantity2+" PRICE ="+sum2);
        ...
        if(e.getSource()==plus3)
        {
            ...
            item3.setText("<html>3.Veg Cheese Sandwich<u> QUANTITY ="+quantity3+" PRICE ="+sum3);
        ...
        if(e.getSource()==plus4)
        {
            ...
            item4.setText("<html>4.Paneer Makhani Sandwich<u> QUANTITY ="+quantity4+" PRICE ="+sum4);
        }
